...
@interface RFLayout ()
@property (nonatomic, assign) CGSize contentItmSize;
@end
...
//    NSLog(@"----%f",offsetAdjustment);
    _changeOfsetBlock?_changeOfsetBlock(CGPointMake(proposedContentOffset.x + offsetAdjustment, proposedContentOffset.y)):nil;
    return CGPointMake(proposedContentOffset.x + offsetAdjustment, proposedContentOffset.y);
}
//- (CGSize)collectionViewContentSize
//{
//    return CGSizeMake(screenWidth * 12, self.contentItmSize.height);
//}
