...
- (void)setModel:(LWMedicationModel *)model
{
    ...
    self.morningCtrLabel.textColor = _model.morningPharmacyControl == 1?[LWThemeManager shareInstance].navBackgroundColor:RGBA(0, 0, 0, .6);
    self.morningMergencyLabel.text = _model.morningPharmacyUrgency == 1?@"是":@"否";
    self.morningMergencyLabel.textColor = _model.morningPharmacyControl == 1?[LWThemeManager shareInstance].navBackgroundColor:RGBA(0, 0, 0, .6);

    self.afternoonCtrLabel.text = _model.afternoonPharmacyControl == 1?@"是":@"否";
    self.afternoonCtrLabel.textColor = _model.afternoonPharmacyControl == 1?[LWThemeManager shareInstance].navBackgroundColor:RGBA(0, 0, 0, .6);
    self.afternoonEmergencyLabel.text = _model.afternoonPharmacyUrgency == 1?@"是":@"否";
    self.afternoonEmergencyLabel.textColor = _model.afternoonPharmacyUrgency == 1?[LWThemeManager shareInstance].navBackgroundColor:RGBA(0, 0, 0, .6);
