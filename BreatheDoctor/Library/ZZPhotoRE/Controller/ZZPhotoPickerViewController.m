...
-(UIButton *)previewBtn{
    if (!_previewBtn) {
        ...
        [_previewBtn setTitleColor:[UIColor colorWithHexString:@"#999999"] forState:UIControlStateNormal];
...
-(void)stepTabbar
{
    ...
    view.sd_layout.heightIs(44).leftSpaceToView(self.view,0).rightSpaceToView(self.view,0).bottomSpaceToView(self.view,0);
    
    viewLine.sd_layout.topSpaceToView(view,0).heightIs(.5).leftSpaceToView(view,0).rightSpaceToView(view,0);

    self.doneBtn.sd_layout.topSpaceToView(viewLine,0).rightSpaceToView(view,0).bottomSpaceToView(view,0).widthIs(45);
    self.previewBtn.sd_layout.topSpaceToView(viewLine,0).leftSpaceToView(view,0).bottomSpaceToView(view,0).widthIs(45);
...
//    _picsCollection.translatesAutoresizingMaskIntoConstraints = NO;
    ...
    _picsCollection.sd_layout.topSpaceToView(self.view,64).leftSpaceToView(self.view,0).rightSpaceToView(self.view,0).bottomSpaceToView(self.view,44);
...
-(void)selectPicBtn:(UIButton *)button
{
    ...
    if (self.selectArray.count > 0) {
        ...
        [_doneBtn setTitleColor:[UIColor colorWithHexString:@"#333333"] forState:UIControlStateNormal];
        [_previewBtn setTitleColor:[UIColor colorWithHexString:@"#333333"] forState:UIControlStateNormal];
