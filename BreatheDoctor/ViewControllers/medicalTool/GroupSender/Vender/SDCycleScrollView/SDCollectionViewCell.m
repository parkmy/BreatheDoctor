...
- (CGSize)imageCFsizeWithSize:(CGSize)size{
    ...
    CGFloat sp = imageSize.width/imageSize.height;
    
    imageSize.height = self.height;
    
    imageSize.width = imageSize.height*sp;
...
- (void)layoutSubviews
{
    ...
    if (self.isSp) {
        CGSize imageSize = [self imageCFsizeWithSize: _imageView.image.size];
