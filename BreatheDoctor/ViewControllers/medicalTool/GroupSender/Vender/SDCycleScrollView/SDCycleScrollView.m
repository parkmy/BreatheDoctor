...
//        if (url) {
            [temp addObject:[UIImage imageNamed:obj]];
//        }
    }];
    self.imageURLsGroup = [temp copy];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    id objc = self.imageURLsGroup[itemIndex];
    if ([objc isKindOfClass:[UIImage class]]) {
        
        cell.imageView.image = objc;
    }else if ([objc isKindOfClass:[NSURL class]]){
        
        [cell.imageView sd_setImageWithURL:objc placeholderImage:self.placeholderImage];
    }
