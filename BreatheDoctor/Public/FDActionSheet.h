...
//typedef void(^TapActionSheetIndexBlock)(NSInteger index,FDActionSheet *sheet);

@property (weak, nonatomic) id<FDActionSheetDelegate> delegate;
@property (strong, nonatomic) NSString *title;
@property (strong, nonatomic) NSString *cancelButtonTitle;

@property (nonatomic, copy) void(^tapActionSheetIndexBlock)(NSInteger index,FDActionSheet *sheet);

//@property (nonatomic, copy) TapActionSheetIndexBlock tapActionSheetIndexBlock;
